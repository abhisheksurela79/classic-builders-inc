          ...
          .animate(
            {
              ...
              scrollTop: isNaN(Number(t))
                ? $(t).offset().top + n.gap.y - 69
                : t,
            },
            n.animation
          );
              ...
              if (
                ...
                var i =
                  ("object" == this.tagName.toLowerCase() || t.attr("height")
                    ? t.attr("height")
                    : t.height()) /
                  (t.attr("width") ? t.attr("width") : t.width());
                if (!t.attr("id")) {
    ...
    var n = o.extend(
      {
        ...
        buttonColor: "#fad04c",
        messageText:
          "<b>Do you hungry ?</b> ðŸª Pursuing navigation on this site, you accept the use of cookies.",
        linkText: "Learn more",
